...
public:
	...
	template <class V2, class I2, class S2>
	friend Vector<V2, I2, S2> operator + (const Vector<V2, I2, S2>& v,const V2& a);	// Add v to every element

	template <class V2, class I2, class S2>
	friend Vector<V2, I2, S2> operator + (const V2& a,	const Vector<V2, I2, S2>& v);

	template <class V2, class I2, class S2>
	friend Vector<V2, I2, S2> operator - (const Vector<V2, I2, S2>& v, const V2& a);	// Subtract v from every element

	template <class V2, class I2, class S2>
	friend Vector<V2, I2, S2> operator - (const V2& a,	const Vector<V2, I2, S2>& v);

	template <class V2, class I2, class S2>
	friend Vector<V2, I2, S2> operator * (const Vector<V2, I2, S2>& v,
										const V2& a);	// Multiply every element by v
