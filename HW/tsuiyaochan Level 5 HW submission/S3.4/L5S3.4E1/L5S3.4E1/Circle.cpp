...
namespace CHRISTINE
{
    namespace CAD
    {
            Circle::Circle() : centerPoint(), m_radius()
            {
            ...
            Circle::Circle(const Point& p, const LineSegment& l) : centerPoint(p), m_radius(l){}
    
            Circle::Circle(const Circle& l):centerPoint(l.centerPoint), m_radius(l.m_radius){}
